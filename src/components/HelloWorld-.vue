  ...
  <div class="container">
    ...
    >
      <div class="text-center">
        <h1 class="text-one" style="color: #6a8255">CHRISTMAS SALE!</h1>
        <!-- Image -->
        <svg
          id="e1a9485c-0f43-4303-9e0d-5e4a75181bc4"
          data-name="Layer 1"
        ...
        >
          <defs>
            <linearGradient
              id="fa2440bd-da04-40b7-bd3b-ddfb35b0a42b"
              x1="592.9"
              y1="385.11"
              x2="592.9"
              y2="236.35"
            ...
            <linearGradient
              id="07fe1e9f-5680-428a-971a-ff84304916dd"
              x1="420.04"
              y1="804.61"
              x2="420.04"
              y2="320.21"
            ...
            />
            <linearGradient
              id="00ef2338-96af-4b11-80f8-5a4c3164adbb"
              x1="811.83"
              y1="471.54"
              x2="811.83"
              y2="185.81"
          ...
          <g opacity="0.5">
            ...
            <rect
              ...
              width="3.33"
              height="18.87"
              transform="translate(195.93 -230.9) rotate(90)"
              fill="#47e6b1"
            />
          </g>
          <g opacity="0.5">
            ...
            <rect
              ...
              width="3.33"
              height="18.87"
              transform="translate(1631.97 -203.59) rotate(90)"
              fill="#47e6b1"
            />
          </g>
          <g opacity="0.5">
            ...
            <rect
              ...
              width="3.33"
              height="18.87"
              transform="translate(1079.1 -759.09) rotate(90)"
              fill="#47e6b1"
            />
          </g>
          <g opacity="0.5">
            ...
            <rect
              ...
              width="3.33"
              height="18.87"
              transform="translate(943.1 -963.09) rotate(90)"
              fill="#47e6b1"
            />
          </g>
          <g opacity="0.5">
            ...
            <rect
              ...
              width="3.33"
              height="18.87"
              transform="translate(354.13 -392.27) rotate(90)"
              fill="#47e6b1"
            />
          </g>
          <path
          ...
          <g opacity="0.5">
            <path
              ...
              transform="translate(-169.23 -39.68)"
              fill="url(#fa2440bd-da04-40b7-bd3b-ddfb35b0a42b)"
            />
          </g>
          <path
          ...
          <path
            ...
            transform="translate(-169.23 -39.68)"
            fill="url(#00ef2338-96af-4b11-80f8-5a4c3164adbb)"
          />
          <polygon
            points="651.99 378.3 641.71 397.71 657.69 404.56 667.97 382.87 651.99 378.3"
            fill="#fda57d"
          />
          <path
          ...
          />
          <polygon
            points="666.87 384.88 650.71 379.49 645.9 388.57 661.88 395.43 666.87 384.88"
            opacity="0.1"
          />
          <polygon
            points="725 341.94 740.43 357.56 751.76 344.37 734.15 328.06 725 341.94"
            fill="#fda57d"
          />
          <polygon
            points="734.78 328.82 725.63 342.7 731.48 348.63 743.35 336.76 734.78 328.82"
            opacity="0.1"
          />
          <path
          ...
          />
          <path
            d="M774.66,267.22l23.72-27.44a5,5,0,0,0-.38-6.91l-51.61-39.14-6.28,9.78,40,30.79-17,18.62Z"
            transform="translate(-169.23 -39.68)"
            fill="#fda57d"
          />
          <path
            d="M771.94,243.31l-8.3,9.1,11.53,14.31L787.06,253A34.67,34.67,0,0,1,771.94,243.31Z"
            transform="translate(-169.23 -39.68)"
            opacity="0.1"
          />
          <path
            d="M705.78,273.18,678.93,253a8.16,8.16,0,0,1-2-10.87l40.18-44.71,8.22,8.22-27.75,34.64L714,256.75Z"
            transform="translate(-169.23 -39.68)"
            fill="#fda57d"
          />
          <path
            d="M700.12,269.13l4.39,3.3L712.73,256l-10.32-10.32C702.63,249.18,703.25,262.76,700.12,269.13Z"
            transform="translate(-169.23 -39.68)"
            opacity="0.1"
          />
          <polygon
            points="666.87 313.25 642.22 387.19 666.87 395.41 707.95 313.25 675.09 305.04 666.87 313.25"
            fill="#4d8af0"
          />
          <polygon
          ...
          />
          <path
            d="M725.26,238.07v9.17a17.53,17.53,0,0,0,5.13,12.39l19.51,19.51,6.5-13a16.29,16.29,0,0,0,1.72-7.29v-20.8Z"
            transform="translate(-169.23 -39.68)"
            fill="#fda57d"
          />
          <path
            d="M725.51,248.63c0,.34,0,.67,0,1a24.64,24.64,0,0,0,32.83,0V239.46H725.51Z"
            transform="translate(-169.23 -39.68)"
            opacity="0.1"
          />
          ...
          <polygon
            points="544.67 241.3 545.81 237.87 549.23 240.16 544.67 241.3"
            opacity="0.1"
          />
          <path
          ...
          />
          <polygon
            points="613.17 220.75 612.03 224.17 609.74 220.75 613.17 220.75"
            opacity="0.1"
          />
          <path
            d="M725.26,221.76h41.08s16.43-16.43,0-24.65a56.24,56.24,0,0,0-11.15-3.94c-25-6.34-48.74,14.33-45.53,39.91.76,6,2.93,11,7.38,13.32C734.39,255.54,725.26,221.76,725.26,221.76Z"
        ...
        <p class="mt-4 text-two">
          Get Templates & Plugins as a gift!<br />Hurry up & don't lose your
          chance.
        </p>
        <a
          type="button"
          class="btn btn-danger text-white btn-rounded btn-lg"
          href="https://mdbootstrap.com/sale/"
          ><i class="fas fa-gifts"></i> GET Your gift</a
        >
      </div>
    </div>
  </div>
